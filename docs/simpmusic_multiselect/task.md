...
- [x] 同一ドラッグで元位置へ戻した場合をno-opにする（ビルド成功） <!-- id: 65 -->
- [x] API完了を待たず連続並べ替えできるFIFOキューを実装（ビルド成功） <!-- id: 66 -->
- [ ] 👤 waiting_human: 原位置no-op・連続ドラッグ・バッチToastを最新APKで確認 <!-- id: 67 -->
- [ ] 👤 waiting_human: 固定TopAppBarの編集完了操作をビルド・実機確認する（実装・静的確認済み） <!-- id: 68 -->
- [x] 要件訂正により廃止: Now Playingヘッダーのシークレット・ハイライト切替 <!-- id: 69 -->
...
- [ ] 👤 waiting_human: ホーム上部アクション行のシークレット・ハイライト切替をビルド・実機確認する（実装・静的確認済み） <!-- id: 72 -->
- [ ] 👤 waiting_human: ルートsafeDrawingによるシステムバー重なり解消をビルド・実機確認する（実装・静的確認済み） <!-- id: 73 -->
